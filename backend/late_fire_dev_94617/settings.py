"""
Django settings for late_fire_dev_94617 project.
...
ROOT_URLCONF = 'late_fire_dev_94617.urls'
...
WSGI_APPLICATION = 'late_fire_dev_94617.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_fire_dev_94617 API",
    "DESCRIPTION": "API documentation for late_fire_dev_94617 App",
    "VERSION": "v1",
}
